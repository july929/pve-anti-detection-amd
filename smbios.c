                                      ...
                                      Error **errp)
{
    ...
    t->processor_family = 0xFE; /* Other use Processor Family 2 field */ //李晓流 dds666 modify 0xC6代表 Intel® Core™ i7 processor
    SMBIOS_TABLE_SET_STR(4, processor_manufacturer_str, "Advanced Micro Devices, Inc.");
    ...
    t->processor_upgrade = 0x2A; /* 0x2A AM4 0x21 LGA1151 0x2D LGA1700 */
    ...
    t->processor_characteristics = cpu_to_le16(0x003F); /* Unknown */ //李晓流 dds666 modify 0x4 计算得到代表64-bit Capable
    t->processor_family2 = cpu_to_le16(0x8F); //Other 李晓流 dds666 modify 和t->processor_family保持一致不一致都可以
